...
export class AudioManager extends Component {
    ...
    onLoad() {
        ...
        Settings.instance.on(Events.onBgmVolumeChanged, this.onBgmVolumeChanged, this)
    }

    onDestroy() {
        AudioManager._instance = null;
        Settings.instance.off(Events.onBgmVolumeChanged, this.onBgmVolumeChanged, this)
    }
    init() {
    ...
    playBgm() {
        ...
        as.volume = Settings.instance.bgmVolume;
        this.bgm = as;
    }
    ...
    onBgmVolumeChanged() {
        if (this.bgm) {
            this.bgm.volume = Settings.instance.bgmVolume;
        }
    }
}
